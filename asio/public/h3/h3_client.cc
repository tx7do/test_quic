...
namespace h3
{
	...
	client::client(const executor_type& ex, const udp::endpoint& endpoint, ssl::context& ctx, const quic::settings& s)
	...
	client::client(udp::socket&& socket, ssl::context& ctx, const quic::settings& s)
